...
(ABCI)](https://github.com/renlulu/tendermint/tree/develop/abci)
...
[Tendermint Core](https://github.com/renlulu/tendermint) (the
...
Types](https://github.com/renlulu/tendermint/blob/develop/abci/README.md#message-types).
